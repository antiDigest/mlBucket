...
def readFiles(Files):
    """
        read all files from the list of files. To be deprecated.
    """
...
def readFile(file):
    """
        Read the file and return the list of words found.
    """
...
def read(folder, basePath):
    """
        Read the file, find all words and return to be added to the document class.

        This is done for easy access to probabilities.
    """
